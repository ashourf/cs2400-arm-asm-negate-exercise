...
3. Answer the following questions:
   ...
   It's not like code generated by hand. The assembler has to be more generic and designed for the fastest code in the most general cases not indvidul cases. 
